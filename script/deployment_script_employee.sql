...
WHEN MATCHED
THEN
  UPDATE SET d.department_id = l.department_id, d.department_name = l.department_name
WHEN NOT MATCHED
THEN
...
@"\repo\develop\report\salaries_by_department.sql"

@"\repo\develop\report\employees_by_department.sql"
